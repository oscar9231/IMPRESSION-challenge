...
folders = ['P0301', 'P0402', 'P0502', 'P1402', 'P1502', 'P1702', 'P1802', 'P2002', 'P2102', 'P2202']

path = '/Users/liyuanchao/Documents/Corpus/IMPRESSION/Test_dataset/Participant_Receiver/Physio/'
...
for i in folders:
    ...
    for j in stimuli:
        ...
        with open(j + '.csv', 'r') as in_file, open(j + '_resampled.csv', 'w') as out_file:
            ...
            rows = zip(ecg1_new, ecg2_new, gsr1_new, erg1_new, erg2_new, resp_new, plet_new, temp_new)
            wr = csv.writer(out_file)
            if headers:
                wr.writerow(['2-EXG7', '2-EXG8', '2-GSR1', '2-Erg1', '2-Erg2', '2-Resp', '2-Plet', '2-Temp'])
            for row in rows:
                wr.writerow(row)
...
path = '/Users/liyuanchao/Documents/Corpus/IMPRESSION/Test_dataset/Participant_Receiver/Eye/'
